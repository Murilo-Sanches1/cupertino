        ...
        Row(
          ...
          children: <Widget>[
            ...
            Text(
              ...
              // DateFormat.d("pt_Br").format(dateTime),
              // DateFormat("yMMMd", "pt_BR").add_jm().format(dateTime),
              // DateFormat.yMd("pt_Br").add_jm().format(dateTime),
                  ...
                  children: <Widget>[
                    Column(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          'Imposto ${_currencyFormat.format(model.tax)}',
                          style: Styles.productRowItemPrice,
                        ),
                        const SizedBox(height: 6),
                        Text(
